...
export default interface ITypeVehicleService {
    ...
    findByName(typename: string): Promise<TypeVehicle>
}
...
export default class TypeVehicleService  implements ITypeVehicleService {
    ...
    public async findByName(typeName: string): Promise<TypeVehicle> {
        return this.typeRepositorySql.findByName(typeName)        
    }
