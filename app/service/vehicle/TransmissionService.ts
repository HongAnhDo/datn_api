...
export default interface ITransmissionService {
    ...
    findByName(name: string): Promise<TransmissionVehicle>
    findByTypeId(vhc_type_id: number): Promise<TransmissionVehicle[]>
}
...
export default class TransmissionService  implements ITransmissionService {
    ...
    public async findByName(name: string): Promise<TransmissionVehicle> {
        return this.transmissionRepo.findByName(name)        
    }

    public async findByTypeId(vhc_type_id: number): Promise<TransmissionVehicle[]> {
        return this.transmissionRepo.findByTypeId(vhc_type_id)        
    }
